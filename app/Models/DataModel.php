...
class DataModel extends Model
{
    ...
    public function getmenu(){
        ...
        $menu = DB::select("select t1.id,t1.name,isnull(t1.link) as link,t1.icon,t1.status,t2.menu_id as is_menu FROM tb_menu t1 LEFT JOIN tb_submenu t2 on t2.menu_id = t1.id WHERE t1.status = ? GROUP BY t1.id,t1.name,t1.link,t1.icon,t1.status,t2.menu_id", ['1']);
